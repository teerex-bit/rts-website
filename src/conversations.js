module.exports = {
  ...
  journey: [
    { name: "Awaken", description: "Discover What Is Possible", icon: "awaken", href: "/awaken/" },
    { name: "See Clearly", description: "Discover What Is True", icon: "see", href: "/see-clearly/" },
    { name: "Become", description: "The Inner Person Is Reordered", icon: "become", href: "/become/" },
    { name: "Join", description: "Participate in What God Is Doing", icon: "join", href: "/join/" }
  ],
  benefits: [
    ...
    { icon: "people", title: "Clarity & Next Steps", copy: "Leave with greater clarity and peace." }
  ],
  principles: [
    { icon: "eye", copy: "See what you haven’t been able to see." },
    { icon: "heart", copy: "Find freedom in what God is forming in you." },
    { icon: "cross", copy: "Walk forward with confidence and peace." }
  ],
  support: {
    heading: "Need help?",
    copy: "We’re here if you have questions along the way.",
