...
function courseTop(page) {
  const awakenBrand = page.family === 'awaken' ? `<a class="course-top__brand" href="${links.home}" aria-label="Reforming the Soul home"><span class="course-top__brand-mark" aria-hidden="true"><img src="/assets/page-awaken/curriculum-logo.png" alt=""></span><span class="course-top__brand-type"><strong>Reforming</strong><span><em>the</em> <em>Soul</em></span></span></a>` : '';
