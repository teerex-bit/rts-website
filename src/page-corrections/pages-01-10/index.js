...
function renderPage02() {
  const outcomes = [
    ['◉', 'Discover how formation happens in visible and invisible ways.'],
    ['◌', 'Learn to notice what happens inside you in real life.'],
    ['❧', 'Take your first step in the journey of transformation with God.']
  ];
  ...
  return `<div class="p02-awaken" data-page-number="02" data-editable-source="pages-01-10-corrections">
    <header class="p02-top"><a href="/" aria-label="Reforming the Soul home"><img src="/assets/logo.svg" alt="Reforming the Soul"></a><nav aria-label="Account navigation"><a href="/review/">Dashboard</a><a href="/review/">My Journey</a><a href="/coming-soon/">Resources</a><a href="/coming-soon/">Notes</a><span aria-label="Account">●</span></nav></header>
    <main class="p02-shell">
      ...
      <section class="p02-main">
        ...
        <section class="p02-outcomes" aria-label="In this lesson you will"><h2>In This Lesson You Will</h2><div>${outcomes.map(([icon, copy]) => `<article><span aria-hidden="true">${icon}</span><p>${esc(copy)}</p></article>`).join('')}</div></section>
