...
function renderPage02() {
  ...
  return `<div class="p02-awaken" data-page-number="02" data-editable-source="pages-01-10-corrections">
    <header class="p02-top"><a class="p02-brand" href="/" aria-label="Reforming the Soul home"><img src="/assets/page-awaken/tree-mark.svg" alt=""><span><strong>Reforming</strong><em>the</em> Soul</span></a><nav aria-label="Account navigation"><a href="/review/">Dashboard</a><a href="/review/">My Journey</a><a href="/coming-soon/">Resources</a><a href="/coming-soon/">Notes</a><span class="p02-account" aria-label="Account"><svg aria-hidden="true"><use href="/assets/page-awaken/icons.svg#account"></use></svg></span></nav></header>
...
.p02-brand{display:flex;align-items:center;gap:12px;color:#092039;text-decoration:none}
.p02-brand img{display:block;width:66px;height:66px}
.p02-brand>span{display:grid;grid-template-columns:auto 1fr;align-items:end;font:400 1.72rem/1.05 var(--serif);letter-spacing:.05em;text-transform:uppercase}
.p02-brand strong{grid-column:1/-1;font:inherit}
.p02-brand em{margin-right:7px;font:italic 1.16rem/1.1 var(--serif);letter-spacing:0;text-transform:lowercase}
