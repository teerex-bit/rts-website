...
.p07-rail{display:flex;flex-direction:column;align-self:stretch;padding:28px 20px 0}
.p07-rail nav{gap:16px;padding-bottom:26px;border-bottom:1px solid #ffffff24}
.p07-rail:after{content:"";display:block;flex:1;min-height:132px;margin:0 -20px;background:linear-gradient(180deg,#082e4d 0%,#061d31 100%)}
...
.p07-hero>div{width:56%;min-height:446px;padding:36px 44px 28px 0;background:linear-gradient(90deg,#fffdfa 0%,#fffdfa 62%,rgba(255,253,250,.95) 78%,rgba(255,253,250,.52) 91%,transparent 100%)}
