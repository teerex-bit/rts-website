...
.course-top>a.course-top__brand{position:absolute;left:24px;top:15px;z-index:1;display:flex;align-items:center;gap:10px;height:67px;min-width:0;margin:0;padding:0;color:#092039;border:0;border-radius:0;text-align:left;text-decoration:none}
...
/* Use the same clean Tree of Life treatment on Page 02 and Pages 03–06. */
.p02-brand__mark img{display:block;width:196px;height:67px;max-width:none;mix-blend-mode:multiply}
...
@media (max-width:900px){
  .course-top>a.course-top__brand{position:static;height:55px;margin:0!important}.course-top__brand-mark{width:55px;height:55px;flex-basis:55px}.course-top__brand-mark img{width:161px;height:55px}.course-top__brand-type strong{font-size:1.1rem}.course-top__brand-type em:first-child{font-size:.85rem}.course-top__brand-type em:last-child{font-size:1.55rem}
