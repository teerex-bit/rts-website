    ...
    <main class="p07-shell">
      ...
      <section class="p07-work">
        <article class="p07-main">
          ...
          <section class="p07-movements" aria-labelledby="p07-movements-title"><div class="p07-movements__heading"><span aria-hidden="true"><img src="/assets/icon-see.svg" alt=""></span><p id="p07-movements-title">Two Movements. One Journey.</p></div><div class="p07-movements__steps">${page07.movements.map((movement, index) => `<article class="${index === page07.selectedMovement ? 'is-active' : ''}"><span>${esc(movement.number)}</span><div><small>Part ${index + 1}</small><h3>${esc(movement.title)}</h3><p>${esc(movement.text)}</p></div></article>${index === 0 ? '<i aria-hidden="true">→</i>' : ''}`).join('')}</div></section>
...
@media (min-width:1181px){
  ...
  .course-top:has(+.formation-course-page[data-page-number="06"])>p{grid-column:1}
  .course-top:has(+.formation-course-page[data-page-number="03"]) .course-tools,
  .course-top:has(+.formation-course-page[data-page-number="04"]) .course-tools,
  .course-top:has(+.formation-course-page[data-page-number="05"]) .course-tools,
  .course-top:has(+.formation-course-page[data-page-number="06"]) .course-tools{grid-column:2}
  ...
  /* Keep each Awaken lesson prompt, its round icon, and the first card row
     in one deliberate vertical rhythm. */
  .formation-course-page[data-page-number="03"] .course-section-heading,
  .formation-course-page[data-page-number="04"] .course-section-heading,
  .formation-course-page[data-page-number="05"] .course-section-heading,
  .formation-course-page[data-page-number="06"] .course-section-heading{grid-template-columns:58px minmax(0,1fr);gap:16px;align-items:center;margin:20px 0 18px}
  .formation-course-page[data-page-number="03"] .course-section-heading h2,
  .formation-course-page[data-page-number="04"] .course-section-heading h2,
  .formation-course-page[data-page-number="05"] .course-section-heading h2,
  .formation-course-page[data-page-number="06"] .course-section-heading h2{margin:0 0 7px}
  .formation-course-page[data-page-number="03"] .course-section-heading .course-symbol,
  .formation-course-page[data-page-number="04"] .course-section-heading .course-symbol,
  .formation-course-page[data-page-number="05"] .course-section-heading .course-symbol,
  .formation-course-page[data-page-number="06"] .course-section-heading .course-symbol{width:58px;height:58px}
  ...
  .formation-course-page[data-page-number="04"] .origin-map__center{top:39%;transform:translate(-50%,-50%)}
  ...
  /* The generic leaf badge does not carry enough meaning to repeat through
     these Awaken lessons. Keep the distinct icons that identify card actions. */
  .formation-course-page[data-page-number="03"] .course-callout,
  .formation-course-page[data-page-number="04"] .course-callout,
  .formation-course-page[data-page-number="05"] .course-callout,
  .formation-course-page[data-page-number="06"] .course-callout{grid-template-columns:1fr;padding:18px 22px}
  .formation-course-page[data-page-number="03"] .course-callout>.course-symbol,
  .formation-course-page[data-page-number="04"] .course-callout>.course-symbol,
  .formation-course-page[data-page-number="05"] .course-callout>.course-symbol,
  .formation-course-page[data-page-number="06"] .course-callout>.course-symbol,
  .formation-course-page[data-page-number="03"] .course-section-heading>.course-symbol,
  .formation-course-page[data-page-number="04"] .course-section-heading>.course-symbol,
  .formation-course-page[data-page-number="05"] .course-section-heading>.course-symbol,
  .formation-course-page[data-page-number="06"] .course-section-heading>.course-symbol{display:none}
  .formation-course-page[data-page-number="03"] .course-section-heading,
  .formation-course-page[data-page-number="04"] .course-section-heading,
  .formation-course-page[data-page-number="05"] .course-section-heading,
  ...
  /* Page 08 is a guided reflection. Its right rail follows the Awaken lesson
     grammar: one scenic anchor and two concise truth cards, rather than a
     dashboard of repeated lesson information. */
  .formation-course-page[data-page-number="08"]{grid-template-columns:268px minmax(560px,1fr) 342px;min-height:calc(100vh - 104px);background:#f5f0e7}
  .formation-course-page[data-page-number="08"] .formation-rail{padding-bottom:44px;background:linear-gradient(165deg,#062b49 0%,#083b61 58%,#092d49 100%)}
  .formation-course-page[data-page-number="08"] .formation-rail__lesson-marker{margin-top:auto;padding:20px 10px 2px;border-top:1px solid #ffffff26;color:#dce9ef}
  .formation-course-page[data-page-number="08"] .formation-rail__lesson-marker strong{display:block;color:#d7a640;font-size:.7rem;letter-spacing:.11em;line-height:1.45;text-transform:uppercase}
  .formation-course-page[data-page-number="08"] .formation-rail__lesson-marker strong span{color:#8bb5c7}
  .formation-course-page[data-page-number="08"] .formation-rail__lesson-marker p{margin:9px 0 0;color:#edf3f5;font:italic .88rem/1.48 var(--serif)}
  .formation-course-page[data-page-number="08"] .course-content{grid-column:2;max-width:none;padding:30px clamp(32px,4vw,70px) 42px;background:#fffcf7}
  .formation-course-page[data-page-number="08"] .course-hero{max-width:790px;padding:8px 0 8px}
  .formation-course-page[data-page-number="08"] .course-hero h1{font-size:clamp(3.25rem,4.3vw,4.65rem);line-height:.98}
  .formation-course-page[data-page-number="08"] .course-rule{width:58px;margin:19px 0 22px}
  .formation-course-page[data-page-number="08"] .course-intro p{max-width:720px;font-size:1.02rem;line-height:1.58}
  .formation-course-page[data-page-number="08"] .course-body{max-width:850px;padding:0}
  ...
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card{grid-template-columns:70px minmax(0,1fr) 24px;gap:19px;align-items:center;min-height:148px;padding:21px 22px;border:1px solid #ddd3c3;border-top-width:3px;border-radius:10px;box-shadow:0 6px 16px #15304212;background:linear-gradient(135deg,#fffdfa,#f8f4eb)}
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card:nth-child(1){border-top-color:#1768b0}
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card:nth-child(2){border-top-color:#5b788d}
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card:nth-child(3){border-top-color:#ce901f}
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card:nth-child(4){border-top-color:#315c85}
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card>div{display:contents}
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card .course-symbol{width:60px;height:60px}
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card p{margin:0;font-size:1.02rem;line-height:1.48}
  ...
  .formation-course-page[data-page-number="08"] .lesson-navigation{max-width:850px;margin-top:28px;padding-top:22px}
  .formation-course-page[data-page-number="08"] .course-aside{grid-column:3;background:linear-gradient(180deg,#e9e4d9 0%,#f6f2ea 100%);border-left-color:#d7c9b5}
  /* Align the right-rail group with the lesson heading rather than pinning its
     scenic image to the top edge of the canvas. The image, medallion, and
     cards move as one uninterrupted visual group. */
  .formation-course-page[data-page-number="08"] .course-aside__image{height:218px;margin-top:34px;filter:saturate(1.08) contrast(1.03)}
  .formation-course-page[data-page-number="08"] .course-aside__leaf{top:225px;width:58px;height:58px;color:#bd841e;background:#fffaf0;border:1px solid #dec18e;box-shadow:0 4px 14px #0a294322}
  .formation-course-page[data-page-number="08"] .course-aside__cards{gap:12px;padding:26px 18px 28px}
  .formation-course-page[data-page-number="08"] .course-side-card{padding:21px 20px;background:#fffdf8;border-color:#dfd3c0;border-radius:10px;box-shadow:0 7px 17px #0a294310}
  .formation-course-page[data-page-number="08"] .course-side-card:first-child{border-top:3px solid #c68a25;background:linear-gradient(145deg,#fffdf8,#f9f3e7)}
  .formation-course-page[data-page-number="08"] .course-side-card:last-child{border-top:3px solid #1c6196;background:linear-gradient(145deg,#fffdf8,#edf4f6)}
  .formation-course-page[data-page-number="08"] .course-side-card h2{margin-bottom:13px;color:#103f64;font-size:.72rem;letter-spacing:.12em}
  .formation-course-page[data-page-number="08"] .course-side-card p{margin:0 0 11px;color:#17364d;font-size:.84rem;line-height:1.52}
  .formation-course-page[data-page-number="08"] .course-side-card p:last-child{margin-bottom:0;color:#50613e;font-family:var(--serif);font-size:.91rem;line-height:1.44}
  .formation-course-page[data-page-number="08"] .course-side-card ul{gap:13px}
  .formation-course-page[data-page-number="08"] .course-side-card li{grid-template-columns:31px 1fr;gap:10px;align-items:start;color:#17364d;font-size:.8rem;line-height:1.42}
  .formation-course-page[data-page-number="08"] .course-side-card li .course-symbol{width:29px;height:29px;color:#1a659b}
...
@media (min-width:931px) and (max-width:1180px){
  .formation-course-page[data-page-number="08"]{grid-template-columns:220px minmax(500px,1fr) 270px;min-height:calc(100vh - 84px)}
  .formation-course-page[data-page-number="08"] .course-content{grid-column:2;padding:28px clamp(28px,3.5vw,52px) 38px;background:#fffcf7}
  .formation-course-page[data-page-number="08"] .course-hero{max-width:700px;padding:8px 0}
  .formation-course-page[data-page-number="08"] .course-hero h1{font-size:clamp(3.15rem,5vw,4.4rem);line-height:.99}
  .formation-course-page[data-page-number="08"] .course-body{max-width:760px;padding:0}
  ...
  .formation-course-page[data-page-number="08"] .course-card-grid--choices{gap:14px}
  .formation-course-page[data-page-number="08"] .course-card-grid--choices .course-card{grid-template-columns:60px minmax(0,1fr) 22px;gap:16px;min-height:140px;padding:19px}
  ...
  .formation-course-page[data-page-number="08"] .course-aside{grid-column:3}
  .formation-course-page[data-page-number="08"] .course-aside__image{height:198px;margin-top:30px}
  .formation-course-page[data-page-number="08"] .course-aside__leaf{top:201px}
  .formation-course-page[data-page-number="08"] .course-aside__cards{gap:12px;padding:26px 12px 20px}
  .formation-course-page[data-page-number="08"] .course-side-card{padding:17px 15px}
  .formation-course-page[data-page-number="08"] .course-side-card p{font-size:.78rem}
  .formation-course-page[data-page-number="08"] .course-side-card li{font-size:.73rem}
}
@media (max-width:930px){
  ...
  .formation-course-page[data-page-number="08"] .course-aside{grid-column:1}
}
...
.p07-top{height:88px;padding:9px 32px}
.p07-top>a img{width:196px;height:auto}
.p07-top nav{gap:46px}
...
.p07-shell{display:grid;grid-template-columns:268px 1fr;min-height:calc(100vh - 88px)}
.p07-rail{align-self:start;padding:28px 20px 30px}
.p07-rail nav{gap:16px;padding-bottom:0}
...
.p07-hero{min-height:530px;padding:42px 26px 42px 34px;background:#fffdfa url('/assets/page-see-clearly/see-clearly-landing-hero.png') right center/auto 100% no-repeat}
...
.p07-movements{display:grid;gap:23px;margin:0;padding:42px clamp(36px,6vw,76px) 44px;border-top:1px solid #ded6ca;border-bottom:1px solid #ded6ca;background:linear-gradient(180deg,#fffdf9,#f5f2eb)}
.p07-movements__heading{display:flex;align-items:center;justify-content:center;gap:11px;color:#145ca7}
.p07-movements__heading>span{display:grid;place-items:center;width:56px;height:56px;border:1px solid #a9c3dc;border-radius:50%}
.p07-movements__heading img{width:23px;height:23px;filter:invert(30%) sepia(30%) saturate(1317%) hue-rotate(168deg) brightness(82%) contrast(96%)}
.p07-movements__heading p{margin:0;font-size:.84rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase}
.p07-movements__steps{display:grid;grid-template-columns:minmax(0,1fr) 56px minmax(0,1fr);gap:22px;align-items:center;width:min(100%,760px);margin:auto}
.p07-movements__steps article{display:grid;grid-template-columns:1fr;gap:0;align-content:center;justify-items:center;min-height:235px;padding:24px;background:#f7f4ee;border:1px solid #ded6ca;border-radius:18px;text-align:center}
.p07-movements__steps article.is-active{background:linear-gradient(145deg,#15568b,#093554);border-color:#093554;color:#fff;box-shadow:0 9px 20px #0a29431c}
.p07-movements__steps article>span{display:grid;place-items:center;width:68px;height:68px;margin-bottom:14px;color:#145ca7;background:#fffdfa;border:1px solid #9fbbd1;border-radius:50%;font-size:.73rem;font-weight:700}
.p07-movements__steps article.is-active>span{border-color:#d9ab50;color:#d79a25;background:transparent}
.p07-movements__steps small{color:#b87617;font-size:.67rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase}
.p07-movements__steps h3{margin:7px 0 12px;color:#092039;font-size:1.08rem;letter-spacing:.04em;text-transform:uppercase}
.p07-movements__steps article.is-active h3{color:#fff}
.p07-movements__steps p{margin:0;font-size:.84rem;line-height:1.48}
.p07-movements__steps>i{color:#c68b24;font-size:1.7rem;font-style:normal;text-align:center}
...
.p07-side-card p,.p07-side-card li{font-size:.74rem;line-height:1.53}
.p07-side-card:last-child{display:grid;align-content:center;min-height:116px;padding:18px 20px}
.p07-side-card:last-child h2{margin-bottom:9px}
.p07-side-card:last-child p{margin:0;font:italic .92rem/1.48 var(--serif)}
...
.p07-side-card ul{display:grid;gap:10px;margin:0;padding:0;list-style:none}.p07-side-card li{display:grid;grid-template-columns:35px 1fr;gap:9px;align-items:start}.p07-side-card li>span{font-size:1.35rem;color:#145ca7}
