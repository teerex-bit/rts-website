...
function rail(page) {
  ...
  return `<aside class="rts-11-15__rail">
    <a class="rts-11-15__brand" href="/"><img src="${brand}" alt="Reforming the Soul"></a>
