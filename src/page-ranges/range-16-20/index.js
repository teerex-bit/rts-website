...
function renderLanding(page) {
  return `<main class="r1620 r1620--landing" data-page-number="${page.number}" data-editable-source="range-16-20">
    ...
    <section class="r1620-movements"><h2><span></span>Two Movements. One Journey.<span></span></h2><div class="r1620-movements__grid">${page.movements.map(movementCard).join('')}</div></section>
