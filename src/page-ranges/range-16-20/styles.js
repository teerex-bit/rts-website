...
.r1620[data-page-number="18"] .r1620-landing-hero{height:540px;background:#e7d6c5}
.r1620[data-page-number="18"] .r1620-landing-hero>img{object-position:center 58%;filter:saturate(1.18) contrast(1.08)}
...
.r1620[data-page-number="18"] .r1620-movement--1{background-image:linear-gradient(90deg,rgba(242,236,248,0) 0 31%,rgba(247,242,249,.68) 41%,#f8f3fa 56%),url('/assets/page-ranges/range-16-20/movement-live-clean.webp');padding-left:245px;background-size:100% 100%,48% 100%;background-position:center,left center}
.r1620[data-page-number="18"] .r1620-movement--2{background-image:linear-gradient(90deg,#fdf8ed 0 46%,rgba(253,248,237,.6) 59%,rgba(253,248,237,0) 75%),url('/assets/page-ranges/range-16-20/movement-become-clean.webp');padding-right:225px;background-size:100% 100%,47% 100%;background-position:center,right center}
...
.r1620[data-page-number="18"] .r1620-movement__heading>.r1620-icon{background:#563080;width:61px;height:61px}
.r1620[data-page-number="18"] .r1620-movement--2 .r1620-movement__heading>.r1620-icon{background:#bd7b21}
