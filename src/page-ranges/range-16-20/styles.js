...
.r1620-anger-comparison{display:grid;gap:14px}
.r1620-anger-image-row,.r1620-anger-content-row{display:grid;grid-template-columns:1fr 1fr;gap:18px}
.r1620-anger-image,.r1620-anger-content{margin:0;border:1px solid #e0d9cf;border-radius:12px;overflow:hidden;background:#f6f3ed}
.r1620-anger-image figcaption{background:#f8f5ef}
.r1620-anger-image h2{text-align:center;text-transform:uppercase;letter-spacing:.04em;font-size:12px;margin:0;padding:7px;font-family:Arial,sans-serif;font-weight:700}
.r1620-anger-image>img{width:100%;height:210px;object-fit:cover}
.r1620-anger-content ul{list-style:none;padding:4px 12px 8px;margin:0}
.r1620-anger-content li{display:flex;gap:10px;align-items:center;padding:7px 0;border-bottom:1px solid #ddd5c8;font-size:12px;line-height:1.2}
.r1620-anger-content li:last-child{border-bottom:0}
.r1620-anger-content li .r1620-icon{background:#98966a;border-radius:50%;padding:5px;width:30px;height:30px;color:white}
.r1620-anger-content li span{display:block}
.r1620-anger-content li small{display:block;font-size:10px;color:#252b2d;margin-top:2px}
...
.r1620[data-page-number="16"] .r1620-anger-comparison{gap:18px}
.r1620[data-page-number="16"] .r1620-anger-image-row,.r1620[data-page-number="16"] .r1620-anger-content-row{align-items:stretch}
.r1620[data-page-number="16"] .r1620-anger-image{display:grid;grid-template-rows:38px 1fr}
.r1620[data-page-number="16"] .r1620-anger-image>img{display:block;height:clamp(190px,19vw,250px);object-fit:cover}
.r1620[data-page-number="16"] .r1620-anger-content ul{padding:10px 16px 12px;display:flex;flex-direction:column;height:100%}
.r1620[data-page-number="16"] .r1620-anger-content li{font-size:13px;min-height:54px;padding:11px 2px;flex:1}
...
.r1620[data-page-number="16"] .r1620-anger-image-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}
.r1620[data-page-number="16"] .r1620-anger-content-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}
.r1620[data-page-number="16"] .r1620-anger-image{background:#f6f3ed}
.r1620[data-page-number="16"] .r1620-anger-image h2{display:grid;place-items:center;padding:0;background:#fbf9f5;font-size:12px;letter-spacing:.055em;height:38px}
.r1620[data-page-number="16"] .r1620-anger-image>img{display:block;height:220px;object-fit:cover}
.r1620[data-page-number="16"] .r1620-anger-content{min-height:274px;background:#f6f3ed}
.r1620[data-page-number="16"] .r1620-anger-content ul{padding:12px 18px 14px;gap:0}
.r1620[data-page-number="16"] .r1620-anger-content li{min-height:61px;padding:11px 0;font-size:13px;line-height:1.28}
.r1620[data-page-number="16"] .r1620-anger-content li .r1620-icon{width:31px;height:31px;padding:6px}
...
@media(max-width:760px){
  ...
  .r1620-pattern-hero{padding:26px 18px 32px;min-height:0}.r1620-pattern-hero::after{background:rgba(250,248,243,.88)}.r1620-pattern-hero>div>h1{font-size:36px}.r1620-practice{position:relative;top:auto;right:auto;width:auto;margin:25px 0}.r1620-patterns{grid-template-columns:1fr;margin-top:25px}.r1620-patterns section{border:0;padding:0}.r1620-patterns section:last-child{padding:0}.r1620-pattern-arrow{margin:14px auto;transform:rotate(90deg)}.r1620-goal{margin-top:25px}.r1620-pattern-hero>.r1620-lesson-pager{margin-top:15px}
}
...
/* Page 18 — Becoming landing: keep the approved composition editable rather than
   treating the reference as a single baked image. */
.r1620[data-page-number="18"]{--purple:#48206f;--purple-2:#7451a1;background:#faf8f4;color:#111a34}
.r1620-become-topbar{height:82px;background:linear-gradient(112deg,#10162f,#1b1b3b 62%,#12162c);display:flex;align-items:center;padding:0 48px;color:#fff;position:relative;z-index:5}
.r1620-become-topbar__brand{height:82px;width:235px;display:flex;align-items:center;margin-right:auto}
.r1620-become-topbar__brand img{width:195px;max-height:68px;object-fit:contain;object-position:left center;filter:brightness(0) invert(1)}
.r1620-become-topbar nav{height:100%;display:flex;align-items:center;gap:46px;margin:auto}
.r1620-become-topbar nav a{height:100%;display:grid;place-items:center;text-transform:uppercase;font-size:13px;font-weight:700;letter-spacing:.035em;position:relative}
.r1620-become-topbar nav a.is-active{color:#dea635}
.r1620-become-topbar nav a.is-active::after{content:'';position:absolute;bottom:16px;width:76px;height:2px;background:#dda331}
.r1620-become-topbar__conversation{margin-left:auto;border:1px solid #ce9429;color:#e3ac3d;border-radius:25px;padding:12px 24px;text-transform:uppercase;font-size:12px;font-weight:700;letter-spacing:.05em}
.r1620[data-page-number="18"] .r1620-landing-hero{height:min(690px,50vw);min-height:520px;background:#e7d6c5}
.r1620[data-page-number="18"] .r1620-landing-hero>img{object-position:center 50%;filter:saturate(1.12) contrast(1.06)}
.r1620[data-page-number="18"] .r1620-landing-hero::after{background:linear-gradient(90deg,#fcfaf7 0%,#fcfaf7 30%,rgba(252,250,247,.96) 38%,rgba(252,250,247,.68) 46%,rgba(252,250,247,.28) 55%,rgba(252,250,247,0) 68%,transparent 100%)}
.r1620[data-page-number="18"] .r1620-landing-copy{left:max(48px,calc((100% - 1440px)/2 + 46px));top:30px;width:455px}
.r1620[data-page-number="18"] .r1620-landing-copy h1{font-size:80px;line-height:.98;letter-spacing:-.035em;margin:8px 0 12px;color:#48206f}
.r1620[data-page-number="18"] .r1620-landing-copy h2{font-size:28px;line-height:1.22;margin:13px 0 17px;color:#111b35}
.r1620[data-page-number="18"] .r1620-landing-copy>p:not(.r1620-eyebrow){font-size:14px;line-height:1.48;margin-bottom:5px}
.r1620[data-page-number="18"] .r1620-landing-copy>strong{font-size:16px;color:#4a2778}
.r1620[data-page-number="18"] .r1620-actions a{background:#fffaf5;border-color:#5b3286;color:#4a2778;border-radius:5px;padding:13px 19px}
.r1620[data-page-number="18"] .r1620-actions a:first-child{background:#4a2778;color:#fff}
.r1620[data-page-number="18"] .r1620-landing-steps{right:max(32px,calc((100% - 1440px)/2 + 30px));top:112px;width:236px;border-color:rgba(211,179,233,.72);background:linear-gradient(145deg,rgba(43,26,63,.93),rgba(24,20,50,.9));padding:12px 20px;box-shadow:0 12px 30px rgba(18,12,38,.24)}
.r1620[data-page-number="18"] .r1620-landing-steps span{min-height:83px;gap:16px}
.r1620[data-page-number="18"] .r1620-landing-steps .r1620-icon{width:37px;height:37px;color:#e2a634}
.r1620[data-page-number="18"] .r1620-landing-steps b{font-size:14px}
.r1620[data-page-number="18"] .r1620-way{min-height:154px;grid-template-columns:190px 1fr 1.25fr;gap:35px;padding:18px max(56px,calc((100% - 1440px)/2 + 54px));background:#fffdfa}
.r1620[data-page-number="18"] .r1620-way h2{font-size:25px;color:#17203a}
.r1620[data-page-number="18"] .r1620-way p{font-size:15px;line-height:1.45;color:#17203a}
.r1620[data-page-number="18"] .r1620-way__art{width:142px;height:114px;background:radial-gradient(circle,#d9c8dc 0%,#ebe3e2 61%,transparent 63%)}
.r1620[data-page-number="18"] .r1620-movements{padding:27px max(32px,calc((100% - 1440px)/2 + 30px)) 28px;background:#fbf9f5}
.r1620[data-page-number="18"] .r1620-movements>h2{font-size:18px;color:#4a2778;margin:0 0 17px}
.r1620[data-page-number="18"] .r1620-movements>h2 .r1620-movements__phrase{width:auto;height:auto;background:none}
.r1620[data-page-number="18"] .r1620-movements__grid{max-width:1240px;min-height:445px;background:transparent;box-shadow:none;border-radius:18px;gap:20px;grid-template-columns:repeat(2,minmax(0,1fr));overflow:hidden}
.r1620[data-page-number="18"] .r1620-movement{border:1px solid #e1d8cd;border-radius:18px;overflow:hidden;padding:30px 32px;background-repeat:no-repeat;box-shadow:0 9px 24px rgba(45,34,23,.12);display:flex;flex-direction:column}
.r1620[data-page-number="18"] .r1620-movement::before{content:'';position:absolute;inset:0;pointer-events:none}
.r1620[data-page-number="18"] .r1620-movement--1{background-image:linear-gradient(90deg,rgba(242,236,248,0) 0 24%,rgba(247,242,249,.72) 29%,#f8f3fa 34%),url('/assets/page-ranges/range-16-20/movement-live-clean.webp');padding-left:225px;background-size:100% 100%,46% 100%;background-position:center,left center}
.r1620[data-page-number="18"] .r1620-movement--2{background-image:linear-gradient(90deg,#fdf8ed 0 62%,rgba(253,248,237,.7) 66%,rgba(253,248,237,0) 72%),url('/assets/page-ranges/range-16-20/movement-become-clean.webp');padding-right:205px;background-size:100% 100%,45% 100%;background-position:center,right center}
.r1620[data-page-number="18"] .r1620-movement__heading,.r1620[data-page-number="18"] .r1620-movement__steps,.r1620[data-page-number="18"] .r1620-movement>a{position:relative;z-index:1}
.r1620[data-page-number="18"] .r1620-movement__heading{min-height:105px}
.r1620[data-page-number="18"] .r1620-movement__heading>span{min-width:0}
.r1620[data-page-number="18"] .r1620-movement__heading h2{font-family:Georgia,'Times New Roman',serif;font-size:30px;font-weight:500;line-height:1.05;color:#211632;margin:5px 0 12px}
.r1620[data-page-number="18"] .r1620-movement__heading p{font-size:14px;line-height:1.5;margin-bottom:18px}
.r1620[data-page-number="18"] .r1620-movement__steps{grid-template-columns:repeat(3,1fr);gap:16px 12px;margin-top:8px}
.r1620[data-page-number="18"] .r1620-movement__steps .r1620-icon{width:46px;height:46px;background:#7650a3}
.r1620[data-page-number="18"] .r1620-movement--2 .r1620-movement__steps .r1620-icon{background:#c78b3b}
.r1620[data-page-number="18"] .r1620-movement__steps small{font-size:10px;color:#17203a;font-weight:700}
.r1620[data-page-number="18"] .r1620-movement>a{display:block;margin-top:auto;padding-top:22px;text-align:center;color:#512c7d;font-size:12px}
.r1620[data-page-number="18"] .r1620-movement--2>a{color:#af6f1e}
.r1620[data-page-number="18"] .r1620-between{background:#fffdf8;border-color:#c68728;color:#bd7720;position:relative;z-index:3;box-shadow:0 2px 10px rgba(38,25,18,.08)}
.r1620[data-page-number="18"] .r1620-landing-quote{min-height:190px;background:radial-gradient(circle at 38% 22%,#422462 0%,#21183f 47%,#10142d 100%);padding:27px max(52px,calc((100% - 1440px)/2 + 55px));gap:60px}
.r1620[data-page-number="18"] .r1620-landing-quote .r1620-icon{width:92px;height:92px;color:#e5a832}
.r1620[data-page-number="18"] .r1620-landing-quote p{font-size:20px;line-height:1.45}
.r1620[data-page-number="18"] .r1620-principles-wrap{background:linear-gradient(105deg,#17152f,#11152d);padding:0 max(32px,calc((100% - 1440px)/2 + 30px)) 26px}
.r1620[data-page-number="18"] .r1620-principles{max-width:1130px;margin:0 auto;transform:none;border-radius:16px;padding:22px 25px;position:relative;z-index:2;box-shadow:0 4px 18px rgba(3,7,24,.22)}
.r1620[data-page-number="18"] .r1620-principles .r1620-icon{background:#3f2c61;width:52px;height:52px}
.r1620[data-page-number="18"] .r1620-principles p{font-size:12px;line-height:1.65}
.r1620[data-page-number="19"] .r1620-lesson-hero blockquote{top:90px}
.r1620[data-page-number="19"] .r1620-lesson-hero blockquote{width:230px;padding:20px 22px}
.r1620[data-page-number="19"] .r1620-lesson-hero blockquote p{margin:10px 0 14px;font-size:16px;line-height:1.42}
.r1620[data-page-number="19"] .r1620-lesson-hero blockquote cite{font:700 13px/1.2 Arial,sans-serif;letter-spacing:.06em;white-space:nowrap}
.r1620[data-page-number="19"] .r1620-screen-columns>article:first-child{display:flex;flex-direction:column;justify-content:space-between;gap:12px}
.r1620[data-page-number="19"] .r1620-screen-columns>article:first-child>p,.r1620[data-page-number="19"] .r1620-screen-columns>article:first-child>ul,.r1620[data-page-number="19"] .r1620-screen-columns>article:first-child>aside{margin-top:0;margin-bottom:0}
@media(max-width:1050px){.r1620-become-topbar{padding-inline:26px}.r1620-become-topbar nav{gap:24px}.r1620[data-page-number="18"] .r1620-landing-copy{left:35px}.r1620[data-page-number="18"] .r1620-landing-steps{right:22px}.r1620[data-page-number="18"] .r1620-movement--1{padding-left:190px;padding-right:20px}.r1620[data-page-number="18"] .r1620-movement--2{padding-left:20px;padding-right:165px}}
@media(max-width:760px){.r1620-become-topbar{height:auto;min-height:78px;padding:8px 16px;flex-wrap:wrap}.r1620-become-topbar__brand{height:50px;width:170px}.r1620-become-topbar__brand img{width:145px;max-height:50px}.r1620-become-topbar nav{order:3;width:100%;height:34px;gap:0;justify-content:space-between}.r1620-become-topbar nav a{font-size:10px}.r1620-become-topbar nav a.is-active::after{bottom:0;width:54px}.r1620-become-topbar__conversation{font-size:9px;padding:9px 11px}.r1620[data-page-number="18"] .r1620-landing-copy{left:22px}.r1620[data-page-number="18"] .r1620-movements__grid{grid-template-columns:1fr;gap:14px;overflow:visible;background:transparent;box-shadow:none}.r1620[data-page-number="18"] .r1620-movement{min-height:0;padding:24px;border-radius:14px;box-shadow:0 7px 18px rgba(45,34,23,.12);background-size:100% 100%,cover;background-position:center}.r1620[data-page-number="18"] .r1620-movement--1{background-image:linear-gradient(rgba(248,243,250,.88),rgba(248,243,250,.88)),url('/assets/page-ranges/range-16-20/movement-live-clean.webp')}.r1620[data-page-number="18"] .r1620-movement--2{background-image:linear-gradient(rgba(253,248,237,.88),rgba(253,248,237,.88)),url('/assets/page-ranges/range-16-20/movement-become-clean.webp')}.r1620[data-page-number="18"] .r1620-movement>a{margin-left:0;text-align:center}.r1620[data-page-number="18"] .r1620-way{padding-inline:25px}.r1620[data-page-number="18"] .r1620-landing-quote{padding-inline:25px}.r1620[data-page-number="18"] .r1620-principles-wrap{padding:0}.r1620[data-page-number="18"] .r1620-principles{margin:0;border-radius:0}.r1620[data-page-number="19"] .r1620-lesson-hero blockquote{top:auto}}
`;
