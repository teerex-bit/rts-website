...
.r1620[data-page-number="18"] .r1620-landing-hero::after{background:linear-gradient(90deg,#fcfaf7 0%,rgba(252,250,247,.98) 22%,rgba(252,250,247,.83) 34%,rgba(252,250,247,.18) 49%,rgba(25,15,42,.08) 78%,rgba(20,11,38,.25) 100%)}
...
.r1620[data-page-number="18"] .r1620-movement--1{background-image:linear-gradient(90deg,rgba(242,236,248,0) 0 35%,rgba(247,242,249,.72) 41%,#f8f3fa 49%),url('/assets/page-ranges/range-16-20/movement-live-clean.webp');padding-left:225px;background-size:100% 100%,46% 100%;background-position:center,left center}
.r1620[data-page-number="18"] .r1620-movement--2{background-image:linear-gradient(90deg,#fdf8ed 0 52%,rgba(253,248,237,.62) 59%,rgba(253,248,237,0) 66%),url('/assets/page-ranges/range-16-20/movement-become-clean.webp');padding-right:205px;background-size:100% 100%,45% 100%;background-position:center,right center}
